...
// I've added the password field for the user registration and authentication and indexes for better performance
function initializeSchema(db: Database) {
	...
	CREATE INDEX IF NOT EXISTS idx_coins_owner_id ON coins(client_id);
  	CREATE INDEX IF NOT EXISTS idx_coins_value ON coins(value);
